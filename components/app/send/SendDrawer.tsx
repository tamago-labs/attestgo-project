...
export default function SendDrawer({
  ...
  const balNum = balance ? formatUnits(balance, row.decimals) : "0";
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-5">
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-muted text-xs">Balance: <span className="text-white/60 font-mono">{Number(balNum).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span></span>
                </div>
              ...
              <div>
                ...
                <input className="w-full border border-border rounded-lg px-3 py-2.5 text-sm font-mono bg-transparent outline-none text-white/70" placeholder="0x... or GO Pass address" />
                <p className="text-muted text-xs mt-1.5">Not a GO Pass address — beneficiary info required below.</p>
              </div>
              ...
              <div className="flex items-center justify-between text-xs pt-1">
                ...
                <span className="text-white/60 font-mono">~0.0021 ETH ($4.10)</span>
              </div>
            </div>
